...
Source0  : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-2.17.tar.xz
...
%prep
%setup -q -n iwd-2.17
cd %{_builddir}/iwd-2.17
pushd ..
cp -a iwd-2.17 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711724129

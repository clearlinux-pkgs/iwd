...
Version  : 3.6
Release  : 71
URL      : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-3.6.tar.gz
Source0  : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-3.6.tar.gz
...
%prep
%setup -q -n iwd-3.6
cd %{_builddir}/iwd-3.6
pushd ..
cp -a iwd-3.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743602109

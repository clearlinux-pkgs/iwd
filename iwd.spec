...
Version  : 2.1
Release  : 40
URL      : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-2.1.tar.xz
Source0  : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-2.1.tar.xz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671468787

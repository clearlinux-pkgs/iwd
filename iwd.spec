...
Version  : 2.21
Release  : 63
URL      : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-2.21.tar.gz
Source0  : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-2.21.tar.gz
...
%prep
%setup -q -n iwd-2.21
cd %{_builddir}/iwd-2.21
pushd ..
cp -a iwd-2.21 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725891612

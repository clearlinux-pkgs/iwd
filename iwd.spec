...
Version  : 2.0
Release  : 39
URL      : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-2.0.tar.xz
Source0  : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-2.0.tar.xz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668786843

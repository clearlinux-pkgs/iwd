...
Version  : 3.4
Release  : 69
URL      : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-3.4.tar.gz
Source0  : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-3.4.tar.gz
...
%prep
%setup -q -n iwd-3.4
cd %{_builddir}/iwd-3.4
pushd ..
cp -a iwd-3.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739286544

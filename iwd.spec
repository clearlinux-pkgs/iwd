...
Version  : 2.2
Release  : 41
URL      : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-2.2.tar.xz
Source0  : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-2.2.tar.xz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674523454

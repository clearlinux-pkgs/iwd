...
Source0  : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-2.19.tar.gz
...
%prep
%setup -q -n iwd-2.19
cd %{_builddir}/iwd-2.19
pushd ..
cp -a iwd-2.19 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720537961

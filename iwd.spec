...
Source0  : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-2.22.tar.gz
...
%prep
%setup -q -n iwd-2.22
cd %{_builddir}/iwd-2.22
pushd ..
cp -a iwd-2.22 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726086981

...
Source0  : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-1.29.tar.xz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657923522
...
cp %{_builddir}/iwd-1.29/COPYING %{buildroot}/usr/share/package-licenses/iwd/32c7c5556c56cdbb2d507e27d28d081595a35a9b
%make_install

...
Version  : 2.18
Release  : 60
URL      : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-2.18.tar.gz
Source0  : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-2.18.tar.gz
...
%prep
%setup -q -n iwd-2.18
cd %{_builddir}/iwd-2.18
pushd ..
cp -a iwd-2.18 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717547283

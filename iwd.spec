...
Version  : 2.12
Release  : 54
URL      : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-2.12.tar.xz
Source0  : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-2.12.tar.xz
...
%prep
%setup -q -n iwd-2.12
cd %{_builddir}/iwd-2.12
pushd ..
cp -a iwd-2.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703694612

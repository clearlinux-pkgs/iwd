...
Version  : 3.7
Release  : 72
URL      : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-3.7.tar.gz
Source0  : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-3.7.tar.gz
...
%prep
%setup -q -n iwd-3.7
cd %{_builddir}/iwd-3.7
pushd ..
cp -a iwd-3.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746455865

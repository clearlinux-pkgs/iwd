...
Source0  : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-3.1.tar.gz
...
%prep
%setup -q -n iwd-3.1
cd %{_builddir}/iwd-3.1
pushd ..
cp -a iwd-3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731018542

...
Version  : 3.3
Release  : 68
URL      : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-3.3.tar.gz
Source0  : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-3.3.tar.gz
...
%prep
%setup -q -n iwd-3.3
cd %{_builddir}/iwd-3.3
pushd ..
cp -a iwd-3.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735083495

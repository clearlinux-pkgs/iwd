...
Source0  : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-3.9.tar.gz
...
%prep
%setup -q -n iwd-3.9
cd %{_builddir}/iwd-3.9
pushd ..
cp -a iwd-3.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750085499

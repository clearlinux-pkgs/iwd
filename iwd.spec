...
Version  : 3.5
Release  : 70
URL      : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-3.5.tar.gz
Source0  : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-3.5.tar.gz
...
%prep
%setup -q -n iwd-3.5
cd %{_builddir}/iwd-3.5
pushd ..
cp -a iwd-3.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743000006

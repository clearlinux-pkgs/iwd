...
Version  : 2.9
Release  : 50
URL      : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-2.9.tar.xz
Source0  : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-2.9.tar.xz
...
%prep
%setup -q -n iwd-2.9
cd %{_builddir}/iwd-2.9
pushd ..
cp -a iwd-2.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1700438913

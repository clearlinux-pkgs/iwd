...
Version  : 2.3
Release  : 42
URL      : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-2.3.tar.xz
Source0  : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-2.3.tar.xz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675374865

...
Version  : 2.14
Release  : 56
URL      : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-2.14.tar.xz
Source0  : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-2.14.tar.xz
...
%prep
%setup -q -n iwd-2.14
cd %{_builddir}/iwd-2.14
pushd ..
cp -a iwd-2.14 buildavx2
popd
pushd ..
cp -a iwd-2.14 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707665160
...
LDFLAGS="$CLEAR_INTERMEDIATE_LDFLAGS -march=x86-64-v3 "
%configure --host=x86_64-clr-linux-gnu --disable-static --enable-wired
make  %{?_smp_mflags}
popd
%check
export LANG=C.UTF-8

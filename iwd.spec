...
Version  : 3.2
Release  : 67
URL      : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-3.2.tar.gz
Source0  : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-3.2.tar.gz
...
%prep
%setup -q -n iwd-3.2
cd %{_builddir}/iwd-3.2
pushd ..
cp -a iwd-3.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732636306

...
Version  : 2.20
Release  : 62
URL      : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-2.20.tar.gz
Source0  : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-2.20.tar.gz
...
%prep
%setup -q -n iwd-2.20
cd %{_builddir}/iwd-2.20
pushd ..
cp -a iwd-2.20 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724940777

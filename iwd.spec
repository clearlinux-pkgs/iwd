...
Version  : 3.0
Release  : 65
URL      : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-3.0.tar.gz
Source0  : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-3.0.tar.gz
...
%prep
%setup -q -n iwd-3.0
cd %{_builddir}/iwd-3.0
pushd ..
cp -a iwd-3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729443819

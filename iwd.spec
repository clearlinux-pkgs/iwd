...
Source0  : https://mirrors.kernel.org/pub/linux/network/wireless/iwd-2.6.tar.xz
...
%prep
%setup -q -n iwd-2.6
cd %{_builddir}/iwd-2.6
pushd ..
cp -a iwd-2.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1687530719
